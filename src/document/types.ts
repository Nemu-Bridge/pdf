import type { ColorValue as ColorObject } from "../lib/color";

export type ColorLike = string | ColorObject;
...
export interface IDocument {
  ...
  fonts: Map<
    string,
    { name: string; path: string; registered: boolean; variable?: boolean }
  >;
  images: Map<
    string,
